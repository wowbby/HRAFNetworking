Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/wowbby/HRAFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'zhengzx' => 'zhengzx@haierubic.com' }
  s.source   = { :git => 'https://github.com/wowbby/HRAFNetworking.git', :tag => s.version, :submodules => true }
  s.requires_arc = true
